...
public final class ColorConverter {
    ...
    public static int[] hexToRGB(String hex) {
        ...
        if (hex.length() == 3) {
            // RGB to RRGGBB
            red = Integer.parseInt(hex.charAt(0) + hex.substring(0, 1), 16);
            green = Integer.parseInt(hex.charAt(1) + hex.substring(1, 2), 16);
            blue = Integer.parseInt(hex.charAt(2) + hex.substring(2, 3), 16);
